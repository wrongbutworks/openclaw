...
export const ja_JP: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      searchPlaceholder: "スケジュール済みタスクを検索",
      newTask: "新規タスク",
      filters: "フィルター",
      shownOf: "{shown} / {total}",
      emptyTitle: "スケジュール済みタスクはまだありません",
      emptyHint:
        "OpenClaw に何をいつ実行するかを記述してください — スケジュールに従って実行されます。",
      noMatching: "現在のフィルターに一致するタスクはありません。",
      loadMore: "さらに読み込む",
      loading: "読み込み中...",
      schedulerOff: "スケジューラーは無効です",
      refresh: "更新",
      refreshing: "更新中...",
      paused: "一時停止中",
    },
    suggestions: {
      ...
      morningBrief: {
        title: "朝のブリーフィング",
        schedule: "平日 午前8:00",
        description: "平日を、夜間のアクティビティと優先事項の要約から始めましょう。",
        prompt:
          "朝のブリーフィングをお願いします: 夜間のアクティビティ、未読メッセージ、今日の最優先事項を要約してください。",
      },
      weeklyReview: {
        title: "週次レビュー",
        schedule: "金曜日 午後4:00",
        description: "毎週金曜日に、その週のセッションを簡潔なステータス更新にまとめます。",
        prompt:
          "週次レビューを書いてください: 今週取り組んだこと、リリースしたもの、未対応のフォローアップを要約してください。",
      },
      followUps: {
        title: "フォローアップモニター",
        schedule: "平日 午前9:00",
        description: "最近の会話を確認し、返信待ちのものにフラグを付けます。",
        prompt: "最近の会話を確認し、返信待ちまたは私の対応が必要なものにフラグを付けてください。",
      },
    },
    stats: {
      scheduler: "スケジューラー",
    ...
    detail: {
      newTitle: "新しいスケジュール済みタスク",
      newSubtitle: "OpenClaw に実行してほしい内容を説明し、次に実行タイミングを選択します。",
      overviewTitle: "最近のアクティビティ",
      overviewSubtitle: "すべてのスケジュール済みタスクの最新実行。",
      historyTitle: "実行履歴",
      detailsSection: "詳細",
      frequencySection: "頻度",
      paused: "一時停止中",
    ...
    form: {
      ...
      promptPlaceholder: "OpenClaw に実行してほしいことを説明してください...",
      repeat: "繰り返し",
      repeatInterval: "間隔",
      repeatOnce: "1 回",
      repeatCron: "Cron 式",
