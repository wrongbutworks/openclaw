...
export const zh_TW: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      shownOf: "{shown} / {total}",
      emptyTitle: "尚無排程任務",
      emptyHint: "描述 OpenClaw 應該做什麼以及何時執行 — 它會依排程執行。",
      noMatching: "沒有符合目前篩選條件的任務。",
      loadMore: "載入更多",
      loading: "載入中...",
      schedulerOff: "排程器已停用",
      refresh: "重新整理",
    ...
    detail: {
      newTitle: "新增排程任務",
      newSubtitle: "描述 OpenClaw 應該執行的動作，然後選擇執行時間。",
      overviewTitle: "近期活動",
      overviewSubtitle: "所有排程任務的最新執行紀錄。",
      historyTitle: "執行歷史",
      detailsSection: "詳細資訊",
      frequencySection: "頻率",
      paused: "已暫停",
    ...
    form: {
      ...
      promptPlaceholder: "描述 OpenClaw 應該做什麼...",
      repeat: "重複",
      repeatInterval: "間隔",
      repeatOnce: "一次",
      repeatCron: "Cron expression",
      repeatOnExit: "結束時",
      onExitHelp: "在受監看指令結束時執行。排程無法在此編輯。",
      every: "每",
      at: "於",
      cronOption: "Cron",
      runAt: "執行時間",
