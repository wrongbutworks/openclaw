...
export const ru: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyTitle: "Запланированных задач пока нет",
      emptyHint:
        "Опишите, что OpenClaw должен сделать и когда — задача будет выполняться по расписанию.",
      noMatching: "Нет задач, соответствующих текущим фильтрам.",
      loadMore: "Загрузить ещё",
      loading: "Загрузка...",
      schedulerOff: "Планировщик отключен",
      refresh: "Обновить",
      refreshing: "Обновление...",
      paused: "Приостановлено",
    },
    suggestions: {
      ...
      morningBrief: {
        ...
        schedule: "По будням в 8:00",
        description: "Начинайте каждый будний день со сводки ночной активности и приоритетов.",
        prompt:
          "Подготовь утреннюю сводку: кратко опиши ночную активность, непрочитанные сообщения и главные приоритеты на сегодня.",
      },
      weeklyReview: {
        title: "Еженедельный обзор",
        schedule: "По пятницам в 16:00",
        description: "Преобразуйте сессии за неделю в краткий статус-отчет каждую пятницу.",
        prompt:
          "Напиши еженедельный обзор: кратко опиши, над чем работали на этой неделе, что было выпущено и какие последующие действия остаются открытыми.",
      },
      followUps: {
        title: "Мониторинг последующих действий",
        schedule: "По будням в 9:00",
        description: "Просматривайте недавние разговоры и отмечайте все, что ожидает ответа.",
        prompt:
          "Просмотреть недавние разговоры и отметить всё, что ожидает ответа или требует моего внимания.",
      },
    },
    stats: {
    ...
    detail: {
      ...
      newSubtitle: "Опишите, что должен сделать OpenClaw, затем выберите время запуска.",
      ...
      frequencySection: "Периодичность",
      paused: "Приостановлено",
    },
    actions: {
      runNow: "Запустить сейчас",
      runIfDue: "Запустить, если срок наступил",
      pause: "Приостановить",
      resume: "Возобновить",
      clone: "Клонировать",
      remove: "Удалить",
    ...
    form: {
      ...
      promptPlaceholder: "Опишите, что должен сделать OpenClaw...",
      repeat: "Повтор",
      ...
      onExitHelp:
        "Выполняется, когда отслеживаемая команда завершается. Расписание нельзя изменить здесь.",
      every: "Каждые",
      at: "В",
      cronOption: "Cron",
      runAt: "Запуск в",
      ...
      runsIn: "Запускается в",
      mainSession: "Основной сеанс",
      isolatedSession: "Изолированный сеанс",
      sessionHelp:
      ...
      startEnabled: "Включить при запуске",
