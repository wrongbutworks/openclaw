...
export const ar: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      searchPlaceholder: "ابحث في المهام المجدولة",
      newTask: "مهمة جديدة",
      filters: "عوامل التصفية",
      shownOf: "{shown} من {total}",
      emptyTitle: "لا توجد مهام مجدولة بعد",
      emptyHint: "صِف ما يجب أن يفعله OpenClaw ومتى — وسيتم تشغيله وفق الجدول.",
      noMatching: "لا توجد مهام تطابق عوامل التصفية الحالية.",
      loadMore: "تحميل المزيد",
      loading: "جارٍ التحميل...",
      schedulerOff: "تم تعطيل المجدول",
      refresh: "تحديث",
      refreshing: "جارٍ التحديث...",
      paused: "متوقفة مؤقتًا",
    },
    suggestions: {
      ...
      morningBrief: {
        title: "موجز الصباح",
        schedule: "أيام الأسبوع في 8:00 ص",
        description: "ابدأ كل يوم من أيام الأسبوع بملخص للنشاط خلال الليل والأولويات.",
        prompt:
          "أعطني موجزًا صباحيًا: لخّص النشاط خلال الليل، والرسائل غير المقروءة، وأهم الأولويات لهذا اليوم.",
      },
      weeklyReview: {
        title: "مراجعة أسبوعية",
        schedule: "أيام الجمعة في 4:00 م",
        description: "حوّل جلسات الأسبوع إلى تحديث حالة موجز كل يوم جمعة.",
        prompt:
          "اكتب مراجعة أسبوعية: لخّص ما تم العمل عليه هذا الأسبوع، وما تم إصداره، والمتابعات المفتوحة.",
      },
      followUps: {
        title: "مراقب المتابعات",
        schedule: "أيام الأسبوع في 9:00 صباحًا",
        description: "راجع المحادثات الأخيرة وضع علامة على أي شيء ينتظر ردًا.",
        prompt: "راجع المحادثات الأخيرة وضع علامة على أي شيء ينتظر ردًا أو يحتاج إلى انتباهي.",
      },
    },
    stats: {
      scheduler: "المجدول",
    ...
    detail: {
      ...
      newSubtitle: "صِف ما يجب على OpenClaw فعله، ثم اختر وقت تشغيله.",
    ...
    form: {
      ...
      promptPlaceholder: "صِف ما يجب أن يفعله OpenClaw...",
      repeat: "تكرار",
      repeatInterval: "الفاصل الزمني",
      repeatOnce: "مرة واحدة",
      repeatCron: "تعبير Cron",
      repeatOnExit: "عند الخروج",
      onExitHelp: "يُشغَّل عند خروج أمر تتم مراقبته. لا يمكن تعديل الجدول هنا.",
      every: "كل",
      at: "عند",
      cronOption: "Cron",
      runAt: "التشغيل عند",
