...
export const uk: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyTitle: "Запланованих завдань ще немає",
      emptyHint: "Опишіть, що OpenClaw має зробити й коли — це виконуватиметься за розкладом.",
      noMatching: "Жодне завдання не відповідає поточним фільтрам.",
      loadMore: "Завантажити ще",
      loading: "Завантаження...",
    ...
    suggestions: {
      ...
      morningBrief: {
        ...
        schedule: "У будні о 8:00 AM",
        description: "Починайте кожен будній день із підсумку нічної активності та пріоритетів.",
        prompt:
          "Дай мені ранковий огляд: підсумуй нічну активність, непрочитані повідомлення та головні пріоритети на сьогодні.",
      },
      weeklyReview: {
        title: "Щотижневий огляд",
        schedule: "Щоп’ятниці о 4:00 PM",
        description: "Перетворюйте сесії за тиждень на стислий статус-апдейт щоп’ятниці.",
        prompt:
          "Напишіть тижневий огляд: підсумуйте, над чим працювали цього тижня, що було випущено та які подальші дії залишаються відкритими.",
      },
      followUps: {
        title: "Монітор подальших дій",
        schedule: "У будні о 9:00",
        description: "Переглядайте нещодавні розмови та позначайте все, що очікує на відповідь.",
        prompt:
          "Перегляньте нещодавні розмови та позначте все, що очікує на відповідь або потребує моєї уваги.",
      },
    },
    stats: {
    ...
    detail: {
      ...
      newSubtitle: "Опишіть, що має робити OpenClaw, а потім виберіть, коли це запускати.",
      overviewTitle: "Нещодавня активність",
      overviewSubtitle: "Останні запуски для всіх запланованих завдань.",
      historyTitle: "Історія запусків",
      detailsSection: "Деталі",
      frequencySection: "Періодичність",
      paused: "Призупинено",
    },
    actions: {
      runNow: "Запустити зараз",
      runIfDue: "Запустити, якщо час настав",
      pause: "Призупинити",
      resume: "Відновити",
      clone: "Клонувати",
      remove: "Видалити",
    ...
    form: {
      ...
      onExitHelp:
        "Запускається, коли відстежувана команда завершує роботу. Розклад не можна редагувати тут.",
      every: "Кожні",
      at: "О",
      cronOption: "Cron",
      runAt: "Запустити о",
      ...
      startEnabled: "Увімкнено під час запуску",
