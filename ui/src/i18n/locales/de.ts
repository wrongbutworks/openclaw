...
export const de: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Beschreiben Sie, was OpenClaw tun soll und wann — es wird nach Zeitplan ausgeführt.",
      noMatching: "Keine Aufgaben entsprechen den aktuellen Filtern.",
      loadMore: "Mehr laden",
      loading: "Wird geladen...",
      schedulerOff: "Zeitplaner deaktiviert",
      refresh: "Aktualisieren",
      refreshing: "Wird aktualisiert...",
      paused: "Pausiert",
    },
    ...
    detail: {
      ...
      newSubtitle:
        "Beschreibe, was OpenClaw tun soll, und wähle dann aus, wann es ausgeführt wird.",
      overviewTitle: "Aktuelle Aktivität",
      overviewSubtitle: "Neueste Ausführungen über alle geplanten Aufgaben hinweg.",
    ...
    form: {
      ...
      promptPlaceholder: "Beschreiben Sie, was OpenClaw tun soll...",
      repeat: "Wiederholen",
