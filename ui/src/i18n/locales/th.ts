...
export const th: TranslationMap = {
  ...
  cron: {
    ...
    list: {
      searchPlaceholder: "ค้นหางานที่กำหนดเวลาไว้",
      newTask: "งานใหม่",
      filters: "ตัวกรอง",
      shownOf: "{shown} จาก {total}",
      emptyTitle: "ยังไม่มีงานที่กำหนดเวลาไว้",
      emptyHint: "อธิบายสิ่งที่ OpenClaw ควรทำและเวลา — ระบบจะทำงานตามกำหนดเวลา",
      noMatching: "ไม่มีงานที่ตรงกับตัวกรองปัจจุบัน",
      loadMore: "โหลดเพิ่มเติม",
      loading: "กำลังโหลด...",
      schedulerOff: "ปิดใช้งานตัวจัดกำหนดการแล้ว",
      refresh: "รีเฟรช",
      refreshing: "กำลังรีเฟรช...",
      paused: "หยุดชั่วคราว",
    },
    suggestions: {
      ...
      morningBrief: {
        title: "สรุปช่วงเช้า",
        schedule: "วันธรรมดาเวลา 8:00 น.",
        description: "เริ่มต้นวันธรรมดาแต่ละวันด้วยสรุปกิจกรรมเมื่อคืนและลำดับความสำคัญ",
        prompt: "สรุปช่วงเช้าให้ฉัน: สรุปกิจกรรมเมื่อคืน ข้อความที่ยังไม่ได้อ่าน และลำดับความสำคัญสูงสุดสำหรับวันนี้",
      },
      weeklyReview: {
        title: "ทบทวนรายสัปดาห์",
        schedule: "วันศุกร์เวลา 16:00 น.",
        description: "เปลี่ยนเซสชันของสัปดาห์ให้เป็นการอัปเดตสถานะที่กระชับทุกวันศุกร์",
        prompt:
          "เขียนรีวิวประจำสัปดาห์: สรุปว่าสัปดาห์นี้ทำงานอะไรไปบ้าง อะไรที่ส่งมอบแล้ว และรายการติดตามผลที่ยังเปิดอยู่",
      },
      followUps: {
        title: "ตัวตรวจสอบการติดตามผล",
        schedule: "วันธรรมดา เวลา 9:00 AM",
        description: "ตรวจทานการสนทนาล่าสุดและทำเครื่องหมายรายการที่กำลังรอการตอบกลับ",
        prompt: "ตรวจทานการสนทนาล่าสุดและทำเครื่องหมายรายการที่กำลังรอการตอบกลับหรือต้องการความสนใจจากฉัน",
      },
    },
    stats: {
      scheduler: "ตัวกำหนดเวลา",
      tasks: "งาน",
      nextWake: "การปลุกครั้งถัดไป",
    },
    detail: {
      newTitle: "งานที่กำหนดเวลาใหม่",
      newSubtitle: "อธิบายว่า OpenClaw ควรทำอะไร จากนั้นเลือกเวลาที่จะเรียกใช้งาน",
      overviewTitle: "กิจกรรมล่าสุด",
      overviewSubtitle: "การเรียกใช้ล่าสุดในงานที่กำหนดเวลาทั้งหมด",
      historyTitle: "ประวัติการเรียกใช้",
    ...
    form: {
      ...
      promptPlaceholder: "อธิบายว่า OpenClaw ควรทำอะไร...",
      repeat: "ทำซ้ำ",
      repeatInterval: "ช่วงเวลา",
      repeatOnce: "ครั้งเดียว",
      repeatCron: "นิพจน์ Cron",
      repeatOnExit: "เมื่อออก",
      onExitHelp: "ทำงานเมื่อคำสั่งที่กำลังเฝ้าดูออก ไม่สามารถแก้ไขกำหนดการได้ที่นี่",
      every: "ทุก",
      at: "เวลา",
      cronOption: "Cron",
      runAt: "ทำงานเมื่อ",
      ...
      startEnabled: "เริ่มแบบเปิดใช้งาน",
