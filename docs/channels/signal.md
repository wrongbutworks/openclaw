...
- **Connect to an existing Signal server:** enter a URL such as `http://127.0.0.1:8080`; OpenClaw verifies the server and writes the URL with `autoStart: false` and `apiMode: "auto"`.
